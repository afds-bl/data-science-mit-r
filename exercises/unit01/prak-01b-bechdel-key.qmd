...
Es gibt `r nrow(bechdel90_13)` solche Filme.
...
Wenn wir die Filme mit `roi < 15`vergrössern, erhalten wir einen besseren Überblick über den Vergleich der Mediane zwischen den Kategorien:
